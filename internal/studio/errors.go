...
var (
	...
	ErrInvalidFinalOutput                  = errors.New("studio finalization produced an invalid PDF")
	ErrInvalidMaterialization              = errors.New("invalid studio materialization parameters")
